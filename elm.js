...
var author$project$Main$init = {
	...
	availableMonsters: _List_fromArray(
		[
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UpdateCount':
				var document = msg.a;
				return A2(author$project$Main$updateCounts, document, model);
			case 'SetCountMethod':
				var method = msg.a;
				return _Utils_update(
					model,
			...
			default:
				return _Utils_update(
					model,
					{
						currentMonster: elm$core$List$head(model.availableMonsters),
						killProgress: 0
					});
		}
	});
...
var author$project$Main$showMonsterOrButton = function (model) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						A3(mdgriffith$elm_ui$Element$rgb255, 0, 190, 0))
					]),
				{
				...
				[
					...
					_List_fromArray(
						[
							...
							author$project$Main$showMonsterOrButton(model)
						]))
				])));
};
