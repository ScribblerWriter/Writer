...
var author$project$Main$dimensionDecoder = A3(
...
var author$project$Main$loggingDecoder = function (realDecoder) {
	return A2(
		elm$json$Json$Decode$andThen,
		function (value) {
			var _n0 = A2(elm$json$Json$Decode$decodeValue, realDecoder, value);
			if (_n0.$ === 'Ok') {
				var decoded = _n0.a;
...
var author$project$Main$getDimensions = function (value) {
	var _n0 = A2(
		elm$json$Json$Decode$decodeValue,
		author$project$Main$loggingDecoder(author$project$Main$dimensionDecoder),
		value);
	if (_n0.$ === 'Ok') {
	...
	return _Utils_Tuple2(
		{
			...
			currentMonster: elm$core$Maybe$Nothing,
			currentText: '',
			killProgress: 0,
		...
		return _Utils_update(
			model,
			{
				...
				killProgress: function () {
					...
					if (_n0.$ === 'Just') {
						var monster = _n0.a;
						return (dif > 0) ? ((_Utils_cmp(model.killProgress + dif, monster.winCount) > -1) ? monster.winCount : (model.killProgress + dif)) : model.killProgress;
					} else {
						return 0;
					}
				}(),
			...
			case 'StartFight':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentMonster: A2(elm$core$Dict$get, name, author$project$Main$availableTargets),
							killProgress: 0,
							showMonsterPicker: false
						}),
					elm$core$Platform$Cmd$none);
...
var author$project$Main$showEditor = function (model) {
	return A2(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$text(
							elm$core$String$fromInt(target.winCount) + ' words'))
					])));
	});
...
var author$project$Main$buildSingleTargetRow = F2(
	function (imageWidth, targets) {
		return A2(
			...
			A2(
				elm$core$List$map,
				author$project$Main$buildSingleTargetSelector(imageWidth),
				targets));
	});
...
var author$project$Main$buildTargetRows = F3(
	function (imagesPerRow, imageWidth, targets) {
		...
		return A2(
			elm$core$List$map,
			author$project$Main$buildSingleTargetRow(imageWidth),
			targetRows);
	});
...
var author$project$Main$showTargetSelector = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$color(
				A3(mdgriffith$elm_ui$Element$rgb255, 108, 160, 229)),
				mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
				mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$fill),
				mdgriffith$elm_ui$Element$padding(25)
			]),
		A3(
			author$project$Main$buildTargetRows,
			imagesPerRow,
			imageWidth,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$fill),
					mdgriffith$elm_ui$Element$inFront(
					model.showMonsterPicker ? A2(author$project$Main$showCircleButton, 'CANCEL', author$project$Main$CancelMonsterPick) : A2(author$project$Main$showCircleButton, 'TARGET!', author$project$Main$PickMonster))
				]),
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							model.showMonsterPicker ? author$project$Main$showTargetSelector(model) : author$project$Main$showEditor(model),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
